...
class PortfoliosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create portfolio" do
    assert_difference("Portfolio.count") do
      post portfolios_url, params: { portfolio: { balance_asset: @portfolio.balance_asset, balance_fiat: @portfolio.balance_fiat, name: @portfolio.name } }
    end
  ...
  test "should update portfolio" do
    patch portfolio_url(@portfolio), params: { portfolio: { balance_asset: @portfolio.balance_asset, balance_fiat: @portfolio.balance_fiat, name: @portfolio.name } }
